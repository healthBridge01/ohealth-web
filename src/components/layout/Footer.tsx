...
export function Footer() {
  return (
    <footer className="grid gap-12 md:gap-16 border-t border-brand-gray-100 bg-brand-gray-100 py-12 md:pt-16 md:pb-12 md:px-20">
      <section className="flex flex-col gap-12 lg:flex-row lg:justify-between px-4 md:px-8">
        <div className="grid gap-8">
          {/* <div className="flex items-center gap-2">
            <Image src="/icons/logo.svg" alt="OHealth logo" width={22} height={22} />
            <span className="text-xl font-semibold text-brand-black-800">OHealth</span>
          </div> */}
          <div className="grid gap-6 md:gap-8">
            <Image
              ...
              className="w-25 h-6"
            />
            <p className="text-base text-brand-neutral-500 max-w-md">
          ...
          <ul className="grid grid-cols-2 md:flex gap-3 md:gap-8 text-base font-medium leading-6 text-brand-neutral-500">
      ...
      <section className="flex flex-col-reverse items-center justify-between gap-4 pt-8 border-t border-brand-neutral-200 md:flex-row px-4 md:px-8">
        <p className="text-base text-brand-neutral-500">
          © {new Date().getFullYear()} OHealth Ltd. All rights reserved.
        </p>
        <div className="flex items-center gap-6 text-brand-neutral-500">
